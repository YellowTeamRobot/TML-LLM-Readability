...
def plot_grade_deviation_by_target(csv_file):
    ...
    method_cols = df.columns[4:9]   # columns 5–9: calculated grades
    ...
    for method in method_cols:
        ...
        plt.title(f"LLM rewrote text given LLM (corrected) grade Level")
        plt.suptitle("")
        ...
        plt.tight_layout()
        plt.savefig(f"LLMcorrected_{method}_boxplot.png")
